...
const webProjects: Project[] = [
  {
    ...
    category: "Web Design",
    type: "web",
    theme: "Práctica — Posicionamiento y diseño en HTML y CSS",
    shortDescription: "Proyecto de práctica para desarrollar habilidades básicas de posicionamiento y diseño recreando una referencia visual únicamente con HTML y CSS.",
    longDescription: "Proyecto de práctica enfocado en aprender los fundamentos de HTML y CSS a partir de la recreación de una imagen de referencia. El objetivo fue estudiar la composición visual, organizar correctamente los elementos y reproducir el diseño utilizando únicamente estructura HTML y estilos CSS.\n\nQué buscamos: Medir y fortalecer las habilidades básicas de maquetación, posicionamiento y diseño visual en HTML y CSS.\n\nQué logramos: Una recreación funcional de la referencia, construida desde cero con HTML y CSS para demostrar el control de la estructura, el espacio y la presentación de los elementos.",
  ...
  },
  {
    ...
    category: "Web Design",
    type: "web",
    theme: "Práctica — Posicionamiento, enlaces y estilos CSS",
    shortDescription: "Pokédex interactiva creada con HTML y CSS para practicar posicionamiento, enlaces, estilos y conexiones entre páginas.",
    longDescription: "Proyecto de práctica creado para medir el dominio de posicionamiento, enlaces, estilos CSS y conexiones entre páginas. La Pokédex permite seleccionar y desplazarse entre varios Pokémon para presentar su información en pantalla. Además, reproduce el sonido de cada Pokémon cuando el cursor pasa sobre su imagen.\n\nQué buscamos: Practicar la organización de contenido, la navegación entre páginas y la creación de una interfaz interactiva utilizando HTML y CSS.\n\nQué logramos: Una Pokédex navegable e interactiva que reúne varias páginas, permite explorar distintos Pokémon y añade reproducción de sonido mediante la interacción con sus imágenes.",
    technologies: ["HTML", "CSS"],
    mediaKind: "web-preview",
    mediaUrl: pokemonImg,
  ...
  },
  {
    ...
    category: "Web Design",
    type: "web",
    theme: "Práctica — Funcionalidad básica con JavaScript",
    shortDescription: "Juego interactivo creado para practicar funciones básicas de JavaScript mediante la selección de color, sombrero y movimiento.",
    longDescription: "Proyecto sencillo en el que la prioridad fue la funcionalidad y no el diseño visual. El usuario puede seleccionar un color, un sombrero y un movimiento; al presionar el botón de ejecutar, el objeto realiza las opciones elegidas.\n\nQué buscamos: Practicar la estructura de una página con HTML y CSS y aprender a utilizar funciones básicas de JavaScript para responder a las acciones del usuario.\n\nQué logramos: Un juego funcional que conecta controles, selecciones y acciones mediante JavaScript.",
  ...
  },
  {
    ...
    category: "Web Design",
    type: "web",
    theme: "Videojuegos — Concepto visual de sitio web",
    shortDescription: "Propuesta visual de una página web para videojuegos, creada como proyecto personal para explorar diseño y composición.",
    longDescription: "Proyecto personal centrado en diseñar la apariencia de una página web relacionada con videojuegos. El objetivo principal fue presentar una propuesta visual, trabajando la composición, los estilos y la organización de los elementos de la interfaz.\n\nNo es una página web real ni una plataforma funcional: sus funciones se limitan a la presentación del diseño y la exploración de una posible identidad visual para un sitio de videojuegos.",
    technologies: ["HTML", "CSS"],
    mediaKind: "web-preview",
