...
const videoProjects: Project[] = [
  {
    ...
    shortDescription: "Video de lanzamiento de marca para una startup de moda. Editado con transiciones cinematográficas y color grading en DaVinci Resolve.",
    longDescription: "Un video de lanzamiento de alta energía producido para una startup de moda. Editado con transiciones cinematográficas, música sincronizada y color grading profesional en DaVinci Resolve. El proyecto incluyó coordinación con el equipo creativo del cliente, selección de tomas, montaje narrativo y entrega en múltiples formatos para redes sociales y uso corporativo.\n\nQué buscamos: Crear una pieza audiovisual que capture la esencia de la marca y genere impacto inmediato en el público objetivo.\n\nQué logramos: Un film de 2 minutos con más de 50,000 visualizaciones en la primera semana de publicación.",
  ...
  },
  {
    ...
    category: "Video Editing",
    type: "video",
    theme: "Tech — Lanzamiento de producto",
    shortDescription: "Reel de presentación de producto con motion design fluido y sincronización de voz para lanzamiento tech.",
    longDescription: "Product showcase reel que presenta las características clave de un dispositivo tecnológico. Incluye animaciones de motion graphics personalizadas, voiceover profesional sincronizado y transiciones de alto impacto. El video fue optimizado para presentaciones corporativas, campañas digitales y uso en ferias de tecnología.",
  ...
  },
  {
    ...
    category: "Video Editing",
    type: "video",
    theme: "Lifestyle — Serie digital",
    shortDescription: "Serie de 12 videos cortos optimizados para Instagram y TikTok con motion graphics personalizados.",
    longDescription: "Serie de contenido short-form diseñada estratégicamente para maximizar el engagement en plataformas sociales. Cada episodio tiene su propia identidad visual dentro de una coherencia de marca, con transiciones de motion design y subtítulos animados para consumo sin audio.",
  ...
  },
  {
    ...
    category: "Video Editing",
    type: "video",
    theme: "Corporativo — Documentación",
    shortDescription: "Documentación completa y video recap de una conferencia corporativa, incluyendo entrevistas y highlights.",
    longDescription: "Full coverage de una conferencia corporativa de 2 días. El video final condensa los momentos más impactantes, entrevistas con ponentes clave y highlights del evento en un recap de 5 minutos. Producido para uso interno, redes sociales y presentaciones de marca.",
